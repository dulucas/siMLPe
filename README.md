# siMLPe
Official implementation for our paper **Back to MLP: A Simple Baseline for Human Motion Prediction(WACV 2023)**, a simple-yet-effective network achieving **SOTA** performance.
